package net.thailan.client.gui;
...
public class ModMenuScreen extends Screen {
    ...
    private void initWidgets() {
        ...
        ArrayList<Hack> hackList = ThaiFoodClient.getInstance().additionManager.getDisplayHacks();
        ...
        ButtonWidget teleportButton = ButtonWidget.builder(
                Text.literal("Teleport " + ThaiFoodClient.teleport.getDistance() + " blocks"),
                button -> {
                    ThaiFoodClient.teleport.teleport();
                }
        ).size(115, 20).build();

        adder.add(teleportButton);

        SliderWidget teleportDistanceSlider = new SliderWidget(0, 0, 115, 20, Text.literal("Tp " + ThaiFoodClient.teleport.getDistance() + " blocks"), ((double) ThaiFoodClient.teleport.getDistance() / 100)) {
            @Override
            ...
            protected void applyValue() {
                ThaiFoodClient.teleport.setDistance((int)(value * 100));
                teleportButton.setMessage(Text.literal("Teleport " + ThaiFoodClient.teleport.getDistance() + " blocks"));
            }
        };
